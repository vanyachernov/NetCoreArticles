...
export default function ArticleCard({ article }: ArticleProps) {
    ...
    return (
        <article className="flex flex-col w-full xl:max-w-[490px] 2xl:max-w-[385px] lg:max-w-[385px] md:max-w-full bg-white rounded-lg shadow-md overflow-hidden"
                ...
                <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center">
                        ...
                        <div className="text-sm">
                            <p className="text-gray-900 leading-none md:max-w-full lg:max-w-[300px] leading-4">{article.author.username}</p>
